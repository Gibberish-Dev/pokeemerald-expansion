...
extern void InitTimeBasedEvents(void);
...
static void CB2_NewGameBirchSpeech_ReturnFromClockUI(void);
static void Task_NewGameBirchSpeech_ShowClockUI(u8);
...
static void CB2_NewGameBirchSpeech_ReturnFromNamingScreen(void)
{
    ...
    ResetTasks();
    taskId = CreateTask(Task_NewGameBirchSpeech_ShowClockUI, 0);
...
static void CB2_NewGameBirchSpeech_ReturnFromClockUI(void)
{
    ...
    LoadPalette(&sBirchSpeechBgGradientPal[1], BG_PLTT_ID(0) + 1, PLTT_SIZEOF(8));
    ResetTasks();
    taskId = CreateTask(Task_NewGameBirchSpeech_ReshowBirch, 0);
    gTasks[taskId].tBG1HOFS = -60;
    ScanlineEffect_Stop();
    ResetSpriteData();
    FreeAllSpritePalettes();
...
static void Task_NewGameBirchSpeech_ShowClockUI(u8 taskId)
{
    gMain.savedCallback = CB2_NewGameBirchSpeech_ReturnFromClockUI;
...
static void AddBirchSpeechObjects(u8 taskId)
{
    ...
    birchSpriteId = CreateTrainerSprite(TRAINER_PIC_FRONT_LEADER_NORMAN, 0x88, 0x3C, 1, NULL);
...
static void NewGameBirchSpeech_ClearWindow(u8 windowId)
{
    ...
    FillWindowPixelRect(windowId, PIXEL_FILL(bgColor), 0, 0, maxCharWidth * winWidth, maxCharHeight * winHeight);
